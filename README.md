# CodeNova 2026: Digital ID Stack Innovation Challenge
...
>
> *Note: Form to be filled using email:* [omarbenzema50@gmail.com](mailto:omarbenzema50@gmail.com)
...
| **Main Hackathon** | Tuesday, 22 September 2026<br>`09:00 AM – 04:00 PM` | 📍 [Symbiosis International University, Dubai](https://maps.google.com/?q=Symbiosis+International+University+Dubai) (In-Person) |

- **Entry:** **Free** *(Limited seats available — valid only if at least 1 team member is an [IEEE](https://www.ieee.org/) member)*


## Eligibility & Team Requirements

- **Participation:** Open to teams or individual participants.
- **IEEE Requirement:** At least one team member (the Team Leader) must be an active [IEEE](https://www.ieee.org/) member and submit a valid IEEE Membership ID in the [registration form](https://docs.google.com/forms/d/e/1FAIpQLSczWiVZIlIVd7nf-bivuWyLeuXc1LfHW_UJx3iR1PuMCTMXYA/viewform?pli=1).
...
- **Patent & IP Support:** Supported by sponsors **IDS** and [**MIT Square**](https://www.mitsquare.com/).
